...
class TimeRange extends React.Component {
    ...
    render() {
        const onChange = ()=>{this.props.onChange(this.props.dayNum, this.state.checked, this.getTimeFrom(), this.getTimeTo())}
        ...
        return (
            <div style={{display:"flex", flexDirection:"row", borderBottom:"dotted rgba(0,0,0,0.1) 1px", height: "35px", marginTop:"7px"}}>
                ...
                <div style={{width:"100%", marginTop:"6px"}}>
                    <ReactSlider min={0} max={72} defaultValue={[this.state.left, this.state.right]} onChange={(value)=>{this.setState({left: value[0], right:value[1]}, onChange)}} withBars />
                </div>
