...
var _utilsGetParamsForRoute = require('./utils/getParamsForRoute');

var _utilsGetParamsForRoute2 = _interopRequireDefault(_utilsGetParamsForRoute);

var _utilsGetRouteQueries = require('./utils/getRouteQueries');

var _utilsGetRouteQueries2 = _interopRequireDefault(_utilsGetRouteQueries);
...
var RouteAggregator = (function () {
  ...
  RouteAggregator.prototype.updateRoute = function updateRoute(routerProps) {
    ...
    routes.forEach(function (route, i) {
      var routeQueries = _utilsGetRouteQueries2['default'](route, routerProps);
      if (!routeQueries) {
        return;
      }
      ...
      _Object$keys(componentMap).forEach(function (key) {
        ...
        var routeParams = _utilsGetParamsForRoute2['default']({ route: route, routes: routes, params: params, location: location });
  ...
  RouteAggregator.prototype.getData = function getData(route, key, queries, params) {
    ...
    for (var _iterator = _Object$keys(params), _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);;) {
      ...
      if (!_lodashIsEqual2['default'](this._data[paramName], params[paramName])) {
