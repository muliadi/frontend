...
var _reactRouterLibRouterContext = require('react-router/lib/RouterContext');

var _reactRouterLibRouterContext2 = _interopRequireDefault(_reactRouterLibRouterContext);
...
var RelayRouterContext = (function (_React$Component) {
  ...
  function RelayRouterContext(props, context) {
    ...
    this.createElement = function (Component, props) {
      ...
      var routeQueries = _utilsGetRouteQueries2['default'](route, props);
  ...
  RelayRouterContext.prototype.renderComponent = function renderComponent() {
    return _react2['default'].createElement(_reactRouterLibRouterContext2['default'], _extends({}, this.props, {
